  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      requestAnimationFrame(() => {
        ...
        const nextParaSpans =
          nextParaRef.current?.querySelectorAll("span span") || []; // Set initial states
        gsap.set(
          [
            headingSpans,
            paraSpans,
      ...
      <section className="next-content" ref={nextContentRef} translate="no">
        ...
        <div className="next-text">
          ...
          <p ref={nextParaRef}>
            ...
            finish Makeups. She have curated atmost of 50,000+ haircuts and
            3000+ makeups in her beauty jouney. Graduating from international
            based beauty school and worked with top beauty professionals, she
            have masters the skill on providing the best service. With a
            20+years of experience and so much of struggles she owned her own
            salon INSTYL HAIR N BRIDAL STUDIO in the years of 2010, which is now
            celebrating 14 years. She is always passionate about her work and
            never miss following trends when it comes to makeup or haircut. Her
            only motive is to give highclass service in a minimal budget to her
            customers. And she super encoraging towards her team members. She
            keeps a periodical training for her team if she updates herself. All
            ladies come to her for a cut or makeup will defintely love her work.
