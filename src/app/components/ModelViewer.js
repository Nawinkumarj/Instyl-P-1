...
const Model = ({ containerSize }) => {
  ...
  const { scene } = useGLTF("/assets/makeup_kit.glb", true, (loader) => {
  ...
  useEffect(() => {
    if (scene && groupRef.current && containerSize.width && containerSize.height) {
...
// ✅ Use React.memo here to prevent unnecessary re-renders
